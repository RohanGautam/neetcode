class Solution:
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
       ...
       # using a dict is an issue because it will inherently be unordered.
        ...
        total=k
        ans=[]
        # this is a double loop but O(n)
        # the number of innter loop evaluatons is bounded to be atmost n total,
        # since it is n total distributed actoss bins and rest are empty.
